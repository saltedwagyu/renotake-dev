...
export default function LandingCard() {
  ...
  return (
    <div className="card" style={{
      ...
      <h1 className="main-title" style={{ fontWeight: 700, fontSize: 32, marginBottom: 4, color: '#09090b', textAlign: 'center' }}>Plan Your Dream Space</h1>
      ...
      <Button variant="primary" onClick={() => router.push('/maintenance')}>
        ✨ Create a Plan
      </Button>
      <div style={{
        width: '100%',
